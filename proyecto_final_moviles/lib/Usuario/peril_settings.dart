                            ...
                            new Container(
                                ...
                                decoration: new BoxDecoration(
                                  ...
                                  image: new DecorationImage(
                                    //Se tiene que llamar a la imagen del usuario aqui
                              ...
                              new Flexible(
                                child: new TextField(
                                  decoration: const InputDecoration(
                                    //Se tiene que llamar el nombre acutal del perfil aqui
                                    hintText: "User name light",
                                  ),
                                  enabled: !_status,
                                  autofocus: !_status,
                          ...
                          child: new Row(
                            ...
                            children: <Widget>[
                              new Flexible(
                                child: new TextField(
                                  decoration: const InputDecoration(
                                    //Se ingresa el nombre actual de usuario
                                      hintText: "Mobile Number User"),
                                  enabled: !_status,
                                ),
                              ),
                            ],
                          ...
                          child: new Row(
                            ...
                            children: <Widget>[
                              new Flexible(
                                child: new TextField(
                                  decoration: const InputDecoration(
                                    //Se ingresa la referencia actual de usuario
                                      hintText: "Referencia User"),
                                  enabled: !_status,
                                ),
                              ),
                            ],
